...
registerMooseObject("StarlingApp", CollisionRayDataValues);

InputParameters
CollisionRayDataValues::validParams()
{
...
CollisionRayDataValues::CollisionRayDataValues(const InputParameters & parameters)
  : GeneralVectorPostprocessor(parameters),
    _study(getUserObject<CollisionRayStudy>("study")),
    _x(declareVector("x")),
    _y(declareVector("y")),
    _z(declareVector("z")),
...
void
CollisionRayDataValues::initialize()
{
  _x.clear();
  _y.clear();
  _z.clear();
...
void
CollisionRayDataValues::execute()
{
...
void
CollisionRayDataValues::finalize()
{
