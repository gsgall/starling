...
registerMooseObject("RayTracingApp", VectorForceKernel);

InputParameters
VectorForceKernel::validParams()
{
...
VectorForceKernel::VectorForceKernel(const InputParameters & params)
...
void
VectorForceKernel::preTrace()
{
  getVectorValues();
}

void
VectorForceKernel::onSegment()
{
}

void
VectorForceKernel::getVectorValues()
{
